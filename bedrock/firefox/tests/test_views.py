...
class TestFirefoxNew(TestCase):
    ...
    def test_variation_speed_scene_1(self, render_mock):
        req = RequestFactory().get('/firefox/new/?xv=speed')
        req.locale = 'de'
        views.new(req)
    ...
    def test_variation_speed_scene_2(self, render_mock):
        req = RequestFactory().get('/firefox/download/thanks/?xv=speed')
        req.locale = 'de'
        views.download_thanks(req)
    ...
    def test_variation_privacy_scene_1(self, render_mock):
        req = RequestFactory().get('/firefox/new/?xv=privacy')
        req.locale = 'de'
        views.new(req)
    ...
    def test_variation_privacy_scene_2(self, render_mock):
        req = RequestFactory().get('/firefox/download/thanks/?xv=privacy')
        req.locale = 'de'
        views.download_thanks(req)
    ...
    def test_variation_oys_scene_1(self, render_mock):
        req = RequestFactory().get('/firefox/new/?xv=oys')
        req.locale = 'de'
        views.new(req)
    ...
    def test_variation_oys_scene_2(self, render_mock):
        req = RequestFactory().get('/firefox/download/thanks/?xv=oys')
        req.locale = 'de'
        views.download_thanks(req)
